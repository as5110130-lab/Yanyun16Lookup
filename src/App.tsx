...
const buildDataSections: DataSection[] = [
  ...
  {
    title: '奇術資料',
    description: '先建立奇術欄位與常用定位，詳細奇術名單待補。',
    items: [
      {
        name: '輸出奇術槽',
        summary: '配置編輯器用於選擇傷害型奇術。',
        details: ['用途：補爆發 / 補循環', '資料狀態：待補奇術名稱、效果、取得方式'],
        tags: ['奇術', '輸出'],
        source: { label: '官方 2026-06-09 修復公告', url: sources.officialFix },
      },
      {
        name: '生存奇術槽',
        summary: '配置編輯器用於選擇保命或減傷型奇術。',
        details: ['用途：副本容錯', '資料狀態：待補奇術名稱、效果、取得方式'],
        tags: ['奇術', '生存'],
        source: { label: '官方 2026-06-09 修復公告', url: sources.officialFix },
      },
      {
        name: '功能奇術槽',
        summary: '配置編輯器用於選擇位移、控制、輔助或機制型奇術。',
        details: ['用途：副本機制 / 探索 / 輔助', '資料狀態：待補奇術名稱、效果、取得方式'],
        tags: ['奇術', '功能'],
        source: { label: '官方 2026-06-09 修復公告', url: sources.officialFix },
      },
    ],
