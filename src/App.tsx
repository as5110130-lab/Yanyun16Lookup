    ...
    items: [
      {
        ...
        details: [
          ...
          '取得方式：清河區域敲響四口大鐘後取得。',
          '資料狀態：國際服資料參考，中文名稱與數值待人工核對',
        ],
        tags: ['奇術', '攻擊型', '範圍', 'PVE', '待核對'],
